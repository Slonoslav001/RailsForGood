...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { Jméno: @volunteer.Jméno, Mail: @volunteer.Mail, Příjmení: @volunteer.Příjmení, Telefon: @volunteer.Telefon } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { Jméno: @volunteer.Jméno, Mail: @volunteer.Mail, Příjmení: @volunteer.Příjmení, Telefon: @volunteer.Telefon } }
